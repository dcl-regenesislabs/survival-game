...
const ProjectileComponent = engine.defineComponent('ProjectileComponent', ProjectileComponentSchema)
...
export function gunSystem(dt: number) {
  if (!Transform.has(engine.PlayerEntity) || !gunEntity) return
